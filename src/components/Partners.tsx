    ...
    <div className="bg-gray-50 dark:bg-slate-900    min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div
          ...
          style={{ backgroundImage: "url(/src/assets/ban4.png)" }} // Remplacez par le chemin de votre image de fond
        >
        ...
        <h1 className="text-xl font-light text-center text-principale dark:text-white mb-12">
          Nos Partenaires
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {data.map((partner: any, index: any) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-800  shadow-lg rounded-lg p-6 flex flex-col items-center text-center"
            >
              <img
                src={partner.image}
              ...
              <a
              target="blank"
              href={partner?.url} className="text-gray-600 dark:text-white  mt-2">
                Visitez leur site →
              </a>
            </div>
          ))}
