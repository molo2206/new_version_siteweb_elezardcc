              ...
              <ul>
                <li key={number}>
                  <a
                    ...
                    aria-current="page"
                    className="cursor-pointer border border-spacing-2 relative z-10 inline-flex items-center bg-principal px-4 py-2 text-sm font-semibold text-brandPrimary focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    {number}
                  </a>
                </li>
