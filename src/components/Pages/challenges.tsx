...
const Challenges = () => {
  ...
  // Simulation du chargement des données (à remplacer par un vrai appel API)
  useEffect(() => {
  ...
  // Squelette d'une carte défi
  const ChallengeSkeleton = () => (
    <div className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-md flex flex-col">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 pt-24 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        {/* En-tête avec visuel (pas de chargement, contenu statique) */}
        ...
        {/* Filtres par thème - skeleton lors du chargement */}
        <div className="flex flex-wrap gap-2 mb-6 border-b dark:border-slate-700 pb-4">
          {loading ? (
            <>
              ...
              <Skeleton width={120} height={34} className="rounded-full" />
              <Skeleton width={110} height={34} className="rounded-full" />
              <Skeleton width={130} height={34} className="rounded-full" />
              <Skeleton width={140} height={34} className="rounded-full" />
              <Skeleton width={90} height={34} className="rounded-full" />
              <Skeleton width={80} height={34} className="rounded-full" />
            </>
          ) : (
            <>
              <button
        ...
        {/* Grille des défis avec skeleton ou contenu réel */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading
            ? Array.from({ length: 6 }).map((_, idx) => <ChallengeSkeleton key={idx} />)
